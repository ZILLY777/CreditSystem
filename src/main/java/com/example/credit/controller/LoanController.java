...
public class LoanController {
    ...
    @PostMapping("order")
    public ResponseEntity<ResponseData<ResponseOrderId>> postOrder(@RequestBody @Valid LoanOrderDTO loanOrderDTO) throws TariffNotFoundException, LoanConsiderationException, LoanAlreadyApproved, TryLaterException {
